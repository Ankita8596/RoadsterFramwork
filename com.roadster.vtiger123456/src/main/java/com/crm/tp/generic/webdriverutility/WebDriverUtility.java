...
public class WebDriverUtility {
	public void switchChildToBrowser(WebDriver driver, String partialURL) {
	...
	public void switchToTheParentBrowser(WebDriver driver, String parentPartialURL) {
		Set<String> set = driver.getWindowHandles();
		Iterator<String> it = set.iterator();
		while (it.hasNext()) {
			String windowId = it.next();
			...
			if (actUrl.contains(parentPartialURL)) {
				break;
			}
		}
	...
	public void pageToloadwithelement(WebDriver driver, WebElement element) {
